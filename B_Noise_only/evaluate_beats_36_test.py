...
def main() -> None:
    ...
    parser.add_argument("--checkpoint", type=Path, default=Path("checkpoint/audio_best_36_noise.pt"))
    parser.add_argument("--head-checkpoint", type=Path, default=Path("checkpoint/beats_head_36_noise.pt"))
    ...
    dataset = NoiseDataset(args.data_root, args.split, load_mix_manifest(args.data_root))
