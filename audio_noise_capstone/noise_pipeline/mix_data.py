"""Dataset interfaces for the 36-label Float32 ``mix-dataset`` export."""
...
class MixNoiseDataset(Dataset):
    """Load single-label mixture/noise pairs from ``mix-dataset``."""
    ...
    def __getitem__(self, index: int) -> dict[str, Any]:
        ...
        return {
            ...
            "oracle_noise": self._load(row, "noise_path"),
